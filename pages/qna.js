      ...
      <section className="text-gray-400 h-screen bg-zinc-900 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
          ...
          <button
            ...
            className="lex mx-auto text-white bg-indigo-500 border-0 my-4 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"
          >
            Summarise
          </button>
          ...
          <button
            ...
            className="lex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"
          >
            Reiterate
          </button>
